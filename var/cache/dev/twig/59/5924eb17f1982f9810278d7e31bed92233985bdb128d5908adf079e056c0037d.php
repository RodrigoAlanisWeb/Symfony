...
class __TwigTemplate_1bcd5fecdebc6b278b8454e7ea9b36ea8dbb418499090544ff1b08628c7afaa9 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"example-wrapper\">
    ...
    <ul>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
            // line 16
            echo "            <li>Tipo: ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["i"], "Tipo", [], "any", false, false, false, 16), "html", null, true);
            echo " Nombre: ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["i"], "Nombre", [], "any", false, false, false, 16), "html", null, true);
            echo "</li>
        ";
        }
...
";
    ...
    {
        return array (  114 => 18,  103 => 16,  99 => 15,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"example-wrapper\">
    ...
    <ul>
        {% for i in data %}
            <li>Tipo: {{ i.Tipo }} Nombre: {{ i.Nombre }}</li>
        {% endfor %}
    </ul>
</div>
{% endblock %}
", "animal/index.html.twig", "/opt/lampp/htdocs/aprendiendo_symfony/templates/animal/index.html.twig");
    }
}
